...
const Menu = ({ setShowMenu }) => {
    return (
        <div className="bg-black bg-opacity-50 w-full min-h-screen absolute top-0 flex justify-center items-center md:hidden z-50">
            <main className=" bg-white rounded-[10px] flex flex-col gap-6 p-6 opacity-100 max-md:w-[327px]">
                <button onClick={() => location.reload()} className="w-full py-3 bg-[#FDA214] rounded-3xl ">Restart</button>
